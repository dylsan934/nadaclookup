...
export const HookScene: React.FC<{ line1: string; line2Highlight: string; line2Rest: string; subtitle: string }> = ({ line1, line2Highlight, line2Rest, subtitle }) => {
  ...
  return (
    ...
    >
      ...
      >
        {line1}<br />
        <span style={{ color: "#7DB4FF" }}>{line2Highlight}</span>
        <span> {line2Rest}</span>
      </div>
