      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="space-y-8">
          {[
            ...
            { icon: BarChart3, title: "Weekly Top 10 Price Movers (Pro)", desc: "See the full top 10 biggest NADAC price increases and decreases every week, ranked by percent change. Free accounts preview the #1 mover in each list." },
